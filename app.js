...
const destinationData = [
  {
    ...
    "destinations": [
      ...
      },
      {
        "name": "Munar",
        "slug": "Munar",
        "description": "Munnar is a picturesque hill station in Kerala known for its lush tea plantations, misty hills, and tranquil natural beauty. It is a perfect getaway for nature lovers and adventure enthusiasts alike.",
        "bestTime": "September - May",
        "duration": "2-3 days",
        "activities": ["Trekking through lush hills and trails", "Boating in Mattupetty and Kundala Lakes", "Spice Plantations and Wildlife sanctuaries", "Local Cuisine", "Shopping for Spices & Tea"],
        "highlights": ["Blossom Park and Carmelagiri Elephant Park", "Kundala Lakes", "Spice Plantations & Wildlife Plantations", "Pleasant Weather"],
        "image": "munar.jpg"
      }
    ]
  },
...
function showDestinationDetail(slug) {
    ...
    // Create destination detail content also <myself> modified
    ...
    const detailContent = `
        ...
        <div class="destination-detail-card">
            <div class="destination-detail-header">
                ...
                <img src="src/${destination.image}" alt="${destination.name}" style="width:100%; height:500px; border-radius:12px;" />
